...
The dataset was divided into training and testing subsets, with 70% allocated for training and 30% for testing. The first row represents the split for the testing data, while the second row corresponds to the training data. The initial two rows pertain to the original dataset, whereas the last two rows represent the dataset with imputed missing values.
